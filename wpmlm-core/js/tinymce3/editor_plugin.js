...
(function() {
	...
	tinymce.PluginManager.requireLangPack('WPMLM');
	 
	tinymce.create('tinymce.plugins.WPMLM', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addCommand('WPMLM', function() {
				ed.windowManager.open({
					file : url + '/window.php',
					width : 360 + ed.getLang('WPMLM.delta_width', 0),
					height : 210 + ed.getLang('WPMLM.delta_height', 0),
					inline : 1
				}, {
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('WPMLM', n.nodeName == 'IMG');
			});
		},
	...
	// Register plugin
	tinymce.PluginManager.add('WPMLM', tinymce.plugins.WPMLM);
