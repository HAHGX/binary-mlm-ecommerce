...
function submitform(frm, show_notification)
{
	...
	if(document.getElementById('loadingimage') != null)	{
		document.getElementById('loadingimage').src = WPMLM_CORE_IMAGES_URL + '/indicator.gif';
		document.getElementById('loadingindicator').style.visibility = 'visible';
	}else if(document.getElementById('alt_loadingimage') != null){
		document.getElementById('alt_loadingimage').src = WPMLM_CORE_IMAGES_URL + '/indicator.gif';
...
function ie_rating_rollover(id,state)
{
	...
	switch(state)
	{
		case 1:
			...
			target_element.style.background = "url(" + WPMLM_CORE_IMAGES_URL + "/blue-star.gif)";
			break;

		default:
			if(target_element.style.background != "url(" + WPMLM_CORE_IMAGES_URL + "/gold-star.gif)")
			{
...
var apply_rating=function(results)
{
	...
	for(i=1;i<=outarr[1];i++)
	{
		...
		document.getElementById(id).style.background = "url(" + WPMLM_CORE_IMAGES_URL + "/gold-star.gif)";
	}
...
function change_pics(command){
	...
	if (command == 1){
		...
		document.getElementById('out_default_pic').innerHTML ="<img id='default_pic' src='" + WPMLM_CORE_IMAGES_URL + "/default-on.gif'>";
		document.getElementById('out_grid_pic').innerHTML ="<img id='grid_pic' style='cursor:pointer;' onclick='change_pics(0)' src='" + WPMLM_CORE_IMAGES_URL + "/grid-off.gif'>";
		...
		document.getElementById('out_default_pic').innerHTML ="<img id='default_pic'  style='cursor:pointer;' onclick='change_pics(1)' src='" + WPMLM_CORE_IMAGES_URL + "/default-off.gif'>";
		document.getElementById('out_grid_pic').innerHTML ="<img id='grid_pic' src='" + WPMLM_CORE_IMAGES_URL + "/grid-on.gif'>";
		if (location1.search(/view_type/)!=-1) {
...
function add_meta_box(results){
	jQuery(".wpmlm_buy_button").before(results);
