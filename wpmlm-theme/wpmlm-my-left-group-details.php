...
{	
	include( wpmlm_get_template_file_path( 'classes/wpmlm-my-left-group-details.class.php' ) );
	$objMyLeft = new MyLeft($key); 	
	$listArr = $objMyLeft->MyLeft($key); 
	$totalLeft = $objMyLeft->MyLeftLegMemberTotal($key); 
...
<div class="gridtable">
	<div class="paging">
	  <form action="">
		...
		Consultants : Total : <strong><?= $totalLeft; ?></strong>&nbsp; 
