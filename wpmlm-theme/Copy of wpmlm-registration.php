			...
			if($intro['num']==1)
			{
				...
				$insert = "INSERT INTO ".WPMLM_TABLE_USER."
						   (
							...
							VALUES
							(
								'".$user_id."','".$username."', '".$user_key."', '', '".$sponsor."', '".$leg."',
								'0','1','0','0','0','0','".date('Y-m-d H:i:s')."',''
				...
				{	//begin most inner if condition
					...
					$msg= "<span style='color:green;'>Congratulations! You have successfully registered.</span><br /><br />
						...
						<p style='font-size:18px; font-weight:bold;'><a href='".wp_login_url( $redirect )."'>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<form name="frm" method="post" action="" onSubmit="return formValidation();">
		<tr>
			...
			<td><input type="text" name="username" id="username" value="<?= htmlentities($_POST['username']);?>" maxlength="20" size="37" onBlur="checkUserNameAvailability(this.value);"><br /><div id="check_user"></div></td>
		</tr>
